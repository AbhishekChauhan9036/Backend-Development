...
if (
  customerDetails.daysSinceLastLogin > 30 &&
  customerDetails.daysSinceLastPurchase > 30
) {
  discountOffer = 20;
}
...
console.log(
  `The discount offer for ${customerDetails.name} is evaluated to be ${discountOffer}`
);
